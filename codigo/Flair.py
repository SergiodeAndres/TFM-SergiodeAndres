...
import sys
sys.path.append('../TFM_proyecto_codigo')

tagger = TextClassifier.load(r'D:\sentiment-en-mix-ft-rnn_v8.pt')
...
def realizar_analisis(corpus, topic, analisis):
        ...
        plt.savefig(f'result_files\\Flair\\Flair2_{topic}_{analisis}.png')
        plt.close()
