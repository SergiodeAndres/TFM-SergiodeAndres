...
def realizar_analisis(corpus, topic, analisis, num_temas=5, num_palabras=10):
        ...
        lsa_topics = Nmf(matriz_termino_doc, num_temas, id2word=diccionario, random_state=1)
        ...
        dfi.export(df_combinado, f'result_files\\GenSim_NMF\\GenSim_NMF_{topic}_{analisis}_{len(corpus_preprocesado)}.png')
