...
def realizar_analisis(corpus, topic, analisis, num_temas=5, num_palabras=10):
        ...
        Top2Vec_model = Top2Vec(lista_corpus, min_count=1, embedding_model='doc2vec', workers=4)
        ...
        dfi.export(df_combinado, f'result_files\\Top2Vec_2\\Top2Vec_2_{topic}_{analisis}_{len(corpus_preprocesado)}.png')
